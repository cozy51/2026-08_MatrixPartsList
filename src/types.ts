...
export type PartsList={id:string;fileName:string;plNo:string;plName:string;plVersion:string;machineId:string;modeId:string;parts:Part[];visible:boolean;importedAt:string};
